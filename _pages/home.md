...
<div class="lx-desc">
  <div class="lx-desc-inner">
    ...
    <a href="{{ '/blog/' | relative_url }}" class="lx-desc-cta">Scopri il blog &nbsp;→</a>
  </div>
</div>
...
<div class="lx-steps">
  ...
  <div class="lx-step">
    ...
    <div class="lx-step-icon">
      <svg viewBox="0 0 24 24"><path d="M4 6h16M4 12h16M4 18h7"></path></svg>
    </div>
  ...
  <div class="lx-step">
    ...
    <div class="lx-step-icon">
      <svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8 19.79 19.79 0 01.1 1.2 2 2 0 012.11 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.59 7.91a16 16 0 006.29 6.29l.77-.77a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"></path></svg>
    </div>
